...
const DEFAULT_ORDERS = [
  {
    ...
    restaurantImage: "https://picsum.photos/200/150?random=10",
  ...
  },
  {
    ...
    restaurantImage: "https://picsum.photos/200/150?random=11",
  ...
  },
  {
    ...
    restaurantImage: "https://picsum.photos/200/150?random=12",
  ...
  },
  {
    ...
    restaurantImage: "https://picsum.photos/200/150?random=13",
...
export default function CustomerDashboard({ orders = DEFAULT_ORDERS }) {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case "Preparing":
        return <ScheduleIcon sx={{ fontSize: 20, color: "#FF6B35" }} />;
      case "Out for delivery":
        return <BikeIcon sx={{ fontSize: 20, color: "#00B2FF" }} />;
      case "Delivered":
        return <CheckIcon sx={{ fontSize: 20, color: "#00C853" }} />;
      default:
                ...
                <CardContent sx={{ p: 3 }}>
                  <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                    <Box
                      sx={{
                        ...
                        height: 8,
                        borderRadius: "50%",
                        bgcolor: getStatusColor(activeOrder.status),
                        mr: 1,
                      }}
                    />
                  ...
                  <Grid container spacing={3} alignItems="center">
                    ...
                    <Grid item xs={12} md={6} sx={{ textAlign: "center" }}>
                      <CardMedia
                        component="img"
                        image={activeOrder.restaurantImage}
          ...
          <Grid item xs={12} md={activeOrder ? 8 : 6} sx={{ display: "flex" }}>
            <Card sx={{ ...ui.card, width: "100%" }}>
              <CardContent sx={{ p: 3, display: "flex", flexDirection: "column", height: "100%" }}>
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                  <RestaurantIcon sx={{ color: "black", mr: 1 }} />
                        ...
                        <CardContent sx={{ p: 2 }}>
                          <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                            <CardMedia
                              ...
                              sx={{ width: 44, height: 44, borderRadius: 1.5, mr: 1.5, objectFit: "cover" }}
                            />
                          ...
                          <Button
                            component={Link}
                            to={`/restaurant/${order.id}`}
                            variant="contained"
                            fullWidth
                            size="small"
                            sx={{ ...ui.blackBtn, borderRadius: 1, fontWeight: 700 }}
                          >
                            Reorder
                          </Button>
                        </CardContent>
              ...
              <CardContent sx={{ p: 3, display: "flex", flexDirection: "column", height: "100%" }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5, mt: 0.5 }}>
                  <Button
                    ...
                    to="/menu"
                    variant="contained"
                    sx={{ ...ui.blackBtn, py: 1.25, borderRadius: 1.5, fontWeight: 700 }}
                    fullWidth
                  >
                    Browse Restaurants
                  </Button>
                  ...
                  {/* Open global cart drawer (no /cart route) */}
                  <Button
                    onClick={openCart}
                    variant="outlined"
                    sx={{
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                >
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    <FavoriteIcon sx={{ color: "#FF385C", mr: 1 }} />
                    <Typography variant="h6" sx={{ fontWeight: 700 }}>
                      Your saved restaurants
                    </Typography>
                  </Box>
                  <Button component={Link} to="/saved" variant="text" sx={{ color: "black", fontWeight: 700 }}>
                    View all
                  </Button>
                </Box>
                        ...
                        <CardContent sx={{ p: 2, display: "flex", flexDirection: "column" }}>
                          <Box sx={{ display: "flex", alignItems: "center", mb: 1.5 }}>
                            <CardMedia
                              ...
                              image={r.image}
                              alt={r.name}
                              sx={{ width: 48, height: 48, borderRadius: 1.5, mr: 1.5, objectFit: "cover" }}
                            />
                            <Box sx={{ flex: 1, minWidth: 0 }}>
                              <Typography
                                variant="subtitle2"
                          ...
                          <Box sx={{ mt: "auto" }}>
                            <Button
                              ...
                              fullWidth
                              disabled={!r.isOpen}
                              sx={{ ...ui.blackBtn, mt: 1, borderRadius: 1, fontWeight: 700 }}
                            >
